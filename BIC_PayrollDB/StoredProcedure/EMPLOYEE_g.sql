     ...
     ------------------------------------------------------------------------------------------
		...
		BEGIN TRY 
			...
			SELECT 
				...
				CAST(ISNULL(DAILYRATE,0)AS DECIMAL(21,2))AS DAILYRATE,
				CAST(ISNULL(WEEKLYRATE,0)AS DECIMAL(21,2))AS WEEKLYRATE,  
				CAST(ISNULL(MONTHLYRATE,0)AS DECIMAL(21,2))AS MONTHLYRATE,  
				CAST(ISNULL(HOURLYRATE,0)AS DECIMAL(21,2))AS HOURLYRATE,  
				CAST(ISNULL(PREVIUSYEARLYPAY,0)AS DECIMAL(21,2))AS PREVIUSYEARLYPAY,  
				LASTINCREAMENTDATE,
				TERMINATIONDATE,
				CAST(ISNULL(AVGHOURPERDAY,0)AS DECIMAL(21,2))AS AVGHOURPERDAY,
				CAST(ISNULL(HOURPERWEEK,0)AS DECIMAL(21,2))AS HOURPERWEEK,
				CAST(ISNULL(DAYSPERMONTH,0)AS DECIMAL(21,2))AS DAYSPERMONTH,  
				ISNULL(WEEKDAYS,'') AS WEEKDAYS,
				CAST(ISNULL(ANNUALSTANDARDLEAVE,0)AS DECIMAL(21,2))AS ANNUALSTANDARDLEAVE,
				CAST(ISNULL(ANNUALSICKLEAVE,0)AS DECIMAL(21,2))AS ANNUALSICKLEAVE,
				CAST(ISNULL(ANNUALOPTIONALLEAVE,0)AS DECIMAL(21,2))AS ANNUALOPTIONALLEAVE, 
				ISACTIVE,
				COMPID, 
			...
			AND 1 = CASE WHEN @pCOMPID =0 THEN 1 WHEN @pCOMPID<>0 AND @pCOMPID=COMPID THEN 1 ELSE 0 END 
